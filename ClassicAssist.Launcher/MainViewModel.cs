...
namespace ClassicAssist.Launcher
{
    public class MainViewModel : BaseViewModel
    {
        ...
        public ICommand OptionsCommand =>
            _optionsCommand ?? ( _optionsCommand = new RelayCommandAsync( ShowOptionsWindow, o => true ) );
        ...
        public ICommand ShowShardsWindowCommand =>
            _showShardsWindowCommand ?? ( _showShardsWindowCommand = new RelayCommandAsync( ShowShardsWindow, o => true ) );
        ...
        private static void RemoveAlternateDataStreams( string path )
        {
            ...
            {
                // Ignore any NTFS-specific or IO errors, common when running under Wine on Linux or different file systems.
            }
        }
        ...
        {
            return ( Avalonia.Application.Current?.ApplicationLifetime as
        ...
        private async Task Start( object obj )
        {
            ...
            {
                ( Avalonia.Application.Current?.ApplicationLifetime as Avalonia.Controls.ApplicationLifetimes.IClassicDesktopStyleApplicationLifetime )?.Shutdown( 0 );
            }
        }
