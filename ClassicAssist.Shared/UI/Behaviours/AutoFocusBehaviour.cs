...
namespace ClassicAssist.Shared.UI.Behaviours
{
    public class AutoFocusBehaviour : Behavior<Control>
    {
        ...
        {
            if ( e.Property.Name == "IsVisible" && e.NewValue is bool boolVal && boolVal )
            {
                AssociatedObject.Focus();
            }
        }

        private void AssociatedObjectOnLoaded( object sender, Avalonia.Interactivity.RoutedEventArgs e )
        {
            AssociatedObject.Focus();
        }
