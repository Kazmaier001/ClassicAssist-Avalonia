...
using Keys = ClassicAssist.Misc.SDLKeys.Keys;
...
namespace ClassicAssist.Data.Hotkeys
{
    ...
    public class ShortcutKeys
    {
        ...
        /// <summary>True when no key, modifier, or mouse binding is set — used by views to hide the hotkey label.</summary>
        public bool IsDefault => Key == Key.None && Modifier == ModKey.None && Mouse == MouseOptions.None;

        public Keys[] ToArray()
        {
            Keys key = (Keys) (int) Key;
