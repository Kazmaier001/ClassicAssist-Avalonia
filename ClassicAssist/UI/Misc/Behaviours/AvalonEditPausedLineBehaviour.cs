...
namespace ClassicAssist.UI.Misc.Behaviours
{
    ...
    {
        public static readonly StyledProperty<bool> IsPausedProperty = AvaloniaProperty.Register<AvalonEditPausedLineBehaviour, bool>( nameof( IsPaused ) );

        public static readonly StyledProperty<int> PausedLineNumberProperty = AvaloniaProperty.Register<AvalonEditPausedLineBehaviour, int>( nameof( PausedLineNumber ) );
        ...
        private static void OnPausedStateChanged( AvaloniaObject d, AvaloniaPropertyChangedEventArgs e )
        {
