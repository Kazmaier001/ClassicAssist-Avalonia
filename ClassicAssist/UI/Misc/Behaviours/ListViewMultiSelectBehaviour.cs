...
namespace ClassicAssist.UI.Misc.Behaviours
{
    ...
    public class ListViewMultiSelectionBehaviour : Behavior<DataGrid>
    {
        public static readonly StyledProperty<IList> SelectedItemsProperty = AvaloniaProperty.Register<ListViewMultiSelectionBehaviour, IList>( nameof( SelectedItems ) );
