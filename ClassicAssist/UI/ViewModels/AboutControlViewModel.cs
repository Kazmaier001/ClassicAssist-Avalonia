...
namespace ClassicAssist.UI.ViewModels
{
    public class AboutControlViewModel : BaseViewModel
    {
        ...
        {
            Process.Start( new ProcessStartInfo( "https://www.paypal.me/reeeetus" ) { UseShellExecute = true } );
        }
        ...
        {
            Process.Start( new ProcessStartInfo( "https://github.com/Reetus/ClassicAssist" ) { UseShellExecute = true } );
        }
