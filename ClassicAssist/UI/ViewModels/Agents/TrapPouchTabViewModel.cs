...
namespace ClassicAssist.UI.ViewModels.Agents
{
    public class TrapPouchTabViewModel : BaseViewModel, ISettingProvider
    {
        ...
        public TrapPouchTabViewModel()
        {
            ...
            _manager.Clear = () => { Dispatcher.UIThread.Invoke( () => Clear( null ) ); };
            _manager.Add = Add;
        }
        ...
        private void Add( int serial )
        {
            ...
            Dispatcher.UIThread.Invoke( () => { Items.Add( new TrapPouchEntry { Serial = serial, Name = item.Name } ); } );
        ...
        private void OnPacketSent( byte[] data, int length )
        {
            ...
            Dispatcher.UIThread.Invoke( () => Items.Remove( item ) );
        ...
        {
            if ( !HuePickerWindow.GetHue( RehueItemsHue, out int hue ) )
            {
                return;
            }
