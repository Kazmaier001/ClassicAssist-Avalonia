...
namespace ClassicAssist.UI.ViewModels
{
    public class RepositionableGumpViewModel : BaseViewModel
    {
        ...
        public RepositionableGumpViewModel( RepositionableGump gump, int initialX, int initialY )
        {
            ...
            // Windows: query CUO's actual window rect. Non-Windows: keep the 3840x2160
            // defaults set above — Avalonia screen lookup is unreliable from arbitrary
            // threads and the defaults work fine as a position-clamp ceiling.
