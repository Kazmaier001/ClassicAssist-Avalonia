...
namespace ClassicAssist.UI.Views.ECV.Settings
{
    ...
    /// </summary>
    public partial class ContainerSetsSettingsControl : UserControl, INotifyPropertyChanged
    {
        public static readonly StyledProperty<ObservableCollection<ContainerSet>> ItemsProperty = AvaloniaProperty.Register<ContainerSetsSettingsControl, ObservableCollection<ContainerSet>>( nameof( Items ) );
