...
namespace ClassicAssist.UI.Views.ECV.Settings.Controls.EditTextBlocks
{
    ...
    /// </summary>
    public partial class GraphicEditTextBlock : UserControl, INotifyPropertyChanged
    {
        public static readonly StyledProperty<int> IDProperty = AvaloniaProperty.Register<GraphicEditTextBlock, int>( nameof( ID ) );

        public static readonly StyledProperty<ClilocEditTextBlock> ClilocEditTextBlockProperty = AvaloniaProperty.Register<GraphicEditTextBlock, ClilocEditTextBlock>( nameof( ClilocEditTextBlock ) );

        public static readonly StyledProperty<HueEditTextBlock> HueEditTextBlockProperty = AvaloniaProperty.Register<GraphicEditTextBlock, HueEditTextBlock>( nameof( HueEditTextBlock ) );
        ...
        private static void IDChangedCallback( AvaloniaObject d, AvaloniaPropertyChangedEventArgs e )
        {
