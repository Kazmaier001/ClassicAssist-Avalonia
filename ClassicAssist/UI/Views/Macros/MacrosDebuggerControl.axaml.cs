...
namespace ClassicAssist.UI.Views.Macros
{
    ...
    /// </summary>
    public partial class MacrosDebuggerControl : UserControl, INotifyPropertyChanged
    {
        public static readonly StyledProperty<MacroEntry> MacroEntryProperty = AvaloniaProperty.Register<MacrosDebuggerControl, MacroEntry>( nameof( MacroEntry ) );

        public static readonly StyledProperty<double> OverlayWidthProperty = AvaloniaProperty.Register<MacrosDebuggerControl, double>( nameof( OverlayWidth ) );
        ...
        {
            ClipboardCompat.SetText( MacroInvoker.GetDisplayValue( SelectedItem.Value, true ) );
        }
        ...
        private void ResizeThumb_DragDelta( object sender, Avalonia.Input.VectorEventArgs e )
        {
